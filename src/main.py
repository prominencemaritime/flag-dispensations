...
def register_alerts(scheduler: AlertScheduler, config: AlertConfig) -> None:
    ...
    # Register Flag Dispensations Alert
    flag_dispensations_alert = FlagDispensationsAlert(config)
    scheduler.register_alert(flag_dispensations_alert.run)
    logger.info("[OK] Registered FlagDispensationsAlert")
